  ...
  return (
    <div className="w-full mx-auto lg:h-full p-4 md:p-8 flex flex-col lg:min-h-0">
      <div className="flex flex-col xl:flex-row gap-8 flex-1 lg:min-h-0">
        ...
        <div className="w-full xl:w-[360px] shrink-0 lg:h-full lg:min-h-0">
          <div className="bg-white border border-[#E5E5E7] rounded-3xl p-6 shadow-sm relative overflow-hidden flex flex-col h-full lg:overflow-y-auto custom-scrollbar">
        ...
        <div className="flex-1 bg-white border border-[#E5E5E7] rounded-3xl p-6 lg:p-8 flex flex-col shadow-sm relative lg:h-full lg:min-h-0 min-w-0">
          ...
          {/* 100 Trees Grid */}
          <div className="flex-1 lg:overflow-y-auto min-h-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-3 mb-8 relative z-10 lg:pr-2 custom-scrollbar h-[500px] lg:h-auto">
