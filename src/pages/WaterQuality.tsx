...
export default function WaterQuality() {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:h-full gap-8 lg:overflow-hidden p-4 md:p-8 lg:min-h-0">
      {/* Left Panel */}
      <div className="w-full lg:w-[360px] xl:w-[400px] shrink-0 flex flex-col bg-white border border-[#E5E5E7] p-6 lg:p-8 rounded-[2rem] shadow-sm lg:overflow-y-auto custom-scrollbar lg:h-full lg:min-h-0">
      ...
      {/* Right Plot */}
      <div className="flex-1 bg-white border border-[#E5E5E7] p-6 lg:p-8 rounded-[2rem] shadow-sm flex flex-col relative overflow-hidden lg:h-full lg:min-h-0 min-w-0">
