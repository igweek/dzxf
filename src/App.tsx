...
const TABS = [
  { id: 'home', path: '/', label: '首页', icon: HomeIcon, component: Home },
  { id: 'cleaning', path: '/datacleaning', label: '数据清洗', icon: Database, component: DataCleaning },
  { id: 'vision', path: '/vision', label: '视觉模型', icon: Eye, component: VisionModel },
  { id: 'feeding', path: '/feeding', label: '智能投喂', icon: Zap, component: SmartFeeding },
  { id: 'water', path: '/waterquality', label: '水质预警', icon: AlertTriangle, component: WaterQuality },
  { id: 'molting', path: '/molting', label: '蜕壳风险', icon: Activity, component: MoltingRisk },
];
...
export default function App() {
  ...
  const activeTabObj = TABS.find(t => t.path === currentPath) || TABS[0];
  const activeTabId = activeTabObj.id;
